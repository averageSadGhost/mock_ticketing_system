        ...
        <div className="relative">
          ...
          <select
            ...
            className={`
              ...
              transition-all duration-200 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100
              ${leftIcon ? 'pl-10' : ''}
              pr-10
              ${error ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 dark:border-gray-600'}
              ${!props.value ? 'text-gray-400 dark:text-gray-500' : 'text-gray-900 dark:text-gray-100'}
              ${className}
            `}
            {...props}
          >
            ...
            {options.map((option) => (
              <option key={option.value} value={option.value} className="text-gray-900 dark:text-gray-100 dark:bg-gray-800">
                {option.label}
              </option>
            ))}
          </select>
